...
class CalendarUpcomingDetails extends StatefulWidget {
  const CalendarUpcomingDetails({super.key});

  @override
  State<CalendarUpcomingDetails> createState() => _CalendarUpcomingDetailsState();
}

class _CalendarUpcomingDetailsState extends State<CalendarUpcomingDetails>
