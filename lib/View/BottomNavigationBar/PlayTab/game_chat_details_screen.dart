...
class GameChatDetailsScreen extends StatefulWidget {
  const GameChatDetailsScreen({super.key});

  @override
  State<GameChatDetailsScreen> createState() => _GameChatDetailsScreenState();
}

class _GameChatDetailsScreenState extends State<GameChatDetailsScreen>
